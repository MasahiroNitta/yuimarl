...
--DROP TABLE PROJECT;
DROP TABLE YM_EVENTVIEW_SPREAD;
DROP TABLE YM_EVENT;
DROP TABLE YM_EVENTVIEWSET;
DROP TABLE YM_EVENTSET;
DROP TABLE YM_EVENTVIEW;
DROP TABLE YM_PARTY_RELATION;
DROP TABLE YM_GOODS;
DROP TABLE YM_CORPORATION;
DROP TABLE YM_ORGANIZATION;
DROP TABLE YM_PERSON;
DROP TABLE YM_PARTY;
DROP TABLE YM_GOODS_CATEGORY;
DROP TABLE YM_ORG_CATEGORY;
DROP TABLE YM_PREFECTURE;
DROP TABLE YM_USER;
